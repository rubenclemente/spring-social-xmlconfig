...
public class FacebookController {
	...
	public String getProfile(ModelMap model) {
		try {
			Facebook facebook = this.connectionRepository.getPrimaryConnection(Facebook.class).getApi();
	...
	public String composer(ModelMap model) {
		try {
			this.connectionRepository.getPrimaryConnection(Facebook.class).getApi();
		} catch (NotConnectedException e) {
			return "facebook/connect";
		}
		return "post";
