...
public class TwitterController {
	...
	public String getProfile(ModelMap model) {
		try {
			Twitter twitter = this.connectionRepository.getPrimaryConnection(Twitter.class).getApi();
	...
	public String composer(ModelMap model) {
		try {
			this.connectionRepository.getPrimaryConnection(Twitter.class).getApi();
		} catch (NotConnectedException e) {
			return "twitter/connect";
		}
		return "post";
